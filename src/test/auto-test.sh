...
run_test_parser parser-generated1 "$PARSER_FAIL" "$DEFAULT_TIMEOUT"
run_test_parser parser-generated2 "$PARSER_FAIL" "$DEFAULT_TIMEOUT"
run_test_parser parser-generated3 "$PARSER_FAIL" "$DEFAULT_TIMEOUT"
run_test_parser parser-generated4 "$PARSER_FAIL" "$DEFAULT_TIMEOUT"
run_test_parser parser-generated5 "$PARSER_FAIL" "$DEFAULT_TIMEOUT"
run_test_parser parser-generated6 "$PARSER_FAIL" "$DEFAULT_TIMEOUT"
run_test_parser parser-generated7 "$PARSER_FAIL" "$DEFAULT_TIMEOUT"
run_test_parser parser-generated8 "$PARSER_FAIL" "$DEFAULT_TIMEOUT"
run_test_parser parser-generated9 "$PARSER_FAIL" "$DEFAULT_TIMEOUT"
