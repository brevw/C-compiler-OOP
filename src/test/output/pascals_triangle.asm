...
sw $ra,0($sp)
# Original instruction: addiu $sp,$sp,-40008
addiu $sp,$sp,-40008
...
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_327_v130
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_304_v119
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_333_v133
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_187_v58
...
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_261_v101
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_342_v137
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_241_v91
...
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_330_v131
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_313_v124
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_214_v76
...
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_320_v126
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_290_v104
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
...
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_334_v129
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_315_v125
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_227_v84
...
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_277_v106
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_344_v138
lw $t0,0($t0)
addi $sp,$sp,-4
sw $t0,0($sp)
la $t0,label_181_v65
...
addi $sp,$sp,-4
sw $t0,0($sp)
# Original instruction: addiu v0,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_37_v0
sw $t5,0($t0)
...
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: addiu v2,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_39_v2
sw $t5,0($t0)
...
label_5_body:
# Original instruction: addiu v7,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_51_v7
sw $t5,0($t0)
...
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: addiu v9,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_53_v9
sw $t5,0($t0)
...
la $t0,label_59_v10
sw $t4,0($t0)
# Original instruction: addiu v11,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_56_v11
sw $t5,0($t0)
...
label_8_body:
# Original instruction: addiu v15,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_65_v15
sw $t5,0($t0)
...
la $t0,label_73_v18
sw $t4,0($t0)
# Original instruction: bne v18,$zero,label_11_
la $t5,label_73_v18
lw $t5,0($t5)
bne $t5,$zero,label_11_
# Original instruction: addiu v19,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_75_v19
sw $t5,0($t0)
...
la $t0,label_80_v20
sw $t4,0($t0)
# Original instruction: addiu v21,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_78_v21
sw $t5,0($t0)
...
la $t0,label_85_v23
sw $t4,0($t0)
# Original instruction: bne v23,$zero,label_11_
la $t5,label_85_v23
lw $t5,0($t5)
bne $t5,$zero,label_11_
...
sw $t5,0($t0)
label_12_:
# Original instruction: beqz v14,label_9_ELSE
la $t5,label_88_v14
lw $t5,0($t5)
beqz $t5,label_9_ELSE
# Original instruction: addiu v26,$fp,-40004
addiu $t5,$fp,-40004
la $t0,label_97_v26
sw $t5,0($t0)
# Original instruction: addiu v27,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_91_v27
sw $t5,0($t0)
...
la $t0,label_98_v28
sw $t4,0($t0)
# Original instruction: li v29,400
li $t5,400
la $t0,label_95_v29
sw $t5,0($t0)
...
la $t0,label_107_v25
sw $t3,0($t0)
# Original instruction: addiu v30,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_101_v30
sw $t5,0($t0)
...
j label_10_END
label_9_ELSE:
# Original instruction: addiu v36,$fp,-40004
addiu $t5,$fp,-40004
la $t0,label_121_v36
sw $t5,0($t0)
# Original instruction: addiu v37,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_115_v37
sw $t5,0($t0)
...
la $t0,label_122_v38
sw $t4,0($t0)
# Original instruction: li v39,400
li $t5,400
la $t0,label_119_v39
sw $t5,0($t0)
...
la $t0,label_131_v35
sw $t3,0($t0)
# Original instruction: addiu v40,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_125_v40
sw $t5,0($t0)
...
la $t0,label_196_v34
sw $t3,0($t0)
# Original instruction: addiu v45,$fp,-40004
addiu $t5,$fp,-40004
la $t0,label_146_v45
sw $t5,0($t0)
# Original instruction: addiu v46,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_136_v46
sw $t5,0($t0)
...
la $t0,label_147_v49
sw $t3,0($t0)
# Original instruction: li v50,400
li $t5,400
la $t0,label_144_v50
sw $t5,0($t0)
...
la $t0,label_160_v44
sw $t3,0($t0)
# Original instruction: addiu v51,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_150_v51
sw $t5,0($t0)
...
la $t0,label_192_v56
sw $t4,0($t0)
# Original instruction: addiu v59,$fp,-40004
addiu $t5,$fp,-40004
la $t0,label_177_v59
sw $t5,0($t0)
# Original instruction: addiu v60,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_167_v60
sw $t5,0($t0)
...
la $t0,label_178_v63
sw $t3,0($t0)
# Original instruction: li v64,400
li $t5,400
la $t0,label_175_v64
sw $t5,0($t0)
...
la $t0,label_187_v58
sw $t3,0($t0)
# Original instruction: addiu v65,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_181_v65
sw $t5,0($t0)
...
sw $t5,0($t4)
label_10_END:
# Original instruction: addiu v70,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_206_v70
sw $t5,0($t0)
# Original instruction: addiu v71,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_199_v71
sw $t5,0($t0)
...
sw $t5,0($t4)
label_7_posttest:
# Original instruction: addiu v75,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_208_v75
sw $t5,0($t0)
...
la $t0,label_214_v76
sw $t4,0($t0)
# Original instruction: addiu v77,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_211_v77
sw $t5,0($t0)
...
la $t0,label_218_v79
sw $t4,0($t0)
# Original instruction: bnez v79,label_8_body
la $t5,label_218_v79
lw $t5,0($t5)
bnez $t5,label_8_body
label_6_next:
# Original instruction: addiu v80,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_228_v80
sw $t5,0($t0)
# Original instruction: addiu v81,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_221_v81
sw $t5,0($t0)
...
sw $t5,0($t4)
label_4_posttest:
# Original instruction: addiu v85,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_230_v85
sw $t5,0($t0)
...
la $t0,label_238_v89
sw $t3,0($t0)
# Original instruction: bnez v89,label_5_body
la $t5,label_238_v89
lw $t5,0($t5)
bnez $t5,label_5_body
label_3_next:
# Original instruction: addiu v90,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_242_v90
sw $t5,0($t0)
...
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: addiu v92,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_244_v92
sw $t5,0($t0)
...
la $t0,label_252_v96
sw $t3,0($t0)
# Original instruction: beqz v96,label_13_next
la $t5,label_252_v96
lw $t5,0($t5)
beqz $t5,label_13_next
label_15_body:
# Original instruction: addiu v97,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_256_v97
sw $t5,0($t0)
...
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: addiu v99,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_258_v99
sw $t5,0($t0)
...
la $t0,label_264_v100
sw $t4,0($t0)
# Original instruction: addiu v101,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_261_v101
sw $t5,0($t0)
# Original instruction: lw v102,0(v101)
la $t5,label_261_v101
lw $t5,0($t5)
lw $t4,0($t5)
la $t0,label_263_v102
sw $t4,0($t0)
# Original instruction: slt v103,v102,v100
la $t5,label_263_v102
lw $t5,0($t5)
la $t4,label_264_v100
lw $t4,0($t4)
slt $t3,$t5,$t4
la $t0,label_268_v103
sw $t3,0($t0)
...
la $t0,label_268_v103
sw $t4,0($t0)
# Original instruction: beqz v103,label_16_next
la $t5,label_268_v103
lw $t5,0($t5)
beqz $t5,label_16_next
label_18_body:
# Original instruction: addiu v106,$fp,-40004
addiu $t5,$fp,-40004
la $t0,label_277_v106
sw $t5,0($t0)
# Original instruction: addiu v107,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_271_v107
sw $t5,0($t0)
...
la $t0,label_278_v108
sw $t4,0($t0)
# Original instruction: li v109,400
li $t5,400
la $t0,label_275_v109
sw $t5,0($t0)
# Original instruction: mul v108,v108,v109
la $t3,label_278_v108
lw $t3,0($t3)
la $t4,label_275_v109
lw $t4,0($t4)
mul $t3,$t3,$t4
la $t0,label_278_v108
sw $t3,0($t0)
# Original instruction: add v105,v106,v108
la $t5,label_277_v106
lw $t5,0($t5)
la $t4,label_278_v108
lw $t4,0($t4)
add $t3,$t5,$t4
la $t0,label_287_v105
sw $t3,0($t0)
# Original instruction: addiu v110,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_281_v110
sw $t5,0($t0)
...
la $t3,label_288_v111
lw $t3,0($t3)
la $t4,label_285_v112
lw $t4,0($t4)
mul $t3,$t3,$t4
la $t0,label_288_v111
sw $t3,0($t0)
# Original instruction: add v104,v105,v111
la $t5,label_287_v105
lw $t5,0($t5)
la $t4,label_288_v111
lw $t4,0($t4)
add $t3,$t5,$t4
la $t0,label_290_v104
sw $t3,0($t0)
# Original instruction: lw v113,0(v104)
la $t5,label_290_v104
lw $t5,0($t5)
lw $t4,0($t5)
la $t0,label_293_v113
sw $t4,0($t0)
...
la $t5,label_293_v113
lw $t5,0($t5)
la $t4,label_294_v114
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: addiu $sp,$sp,-4
addiu $sp,$sp,-4
...
la $t5,label_297_v115
lw $t5,0($t5)
la $t4,label_298_v116
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: addiu $sp,$sp,-4
addiu $sp,$sp,-4
...
# Original instruction: addiu $sp,$sp,4
addiu $sp,$sp,4
# Original instruction: addiu v117,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_308_v117
sw $t5,0($t0)
# Original instruction: addiu v118,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_301_v118
sw $t5,0($t0)
# Original instruction: lw v119,0(v118)
la $t5,label_301_v118
lw $t5,0($t5)
lw $t4,0($t5)
la $t0,label_304_v119
sw $t4,0($t0)
...
la $t5,label_304_v119
lw $t5,0($t5)
la $t4,label_305_v120
lw $t4,0($t4)
add $t3,$t5,$t4
la $t0,label_307_v121
sw $t3,0($t0)
# Original instruction: sw v121,0(v117)
la $t5,label_307_v121
lw $t5,0($t5)
la $t4,label_308_v117
lw $t4,0($t4)
sw $t5,0($t4)
label_17_posttest:
# Original instruction: addiu v122,$fp,-40012
addiu $t5,$fp,-40012
la $t0,label_310_v122
sw $t5,0($t0)
# Original instruction: lw v123,0(v122)
la $t5,label_310_v122
lw $t5,0($t5)
lw $t4,0($t5)
la $t0,label_316_v123
sw $t4,0($t0)
# Original instruction: addiu v124,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_313_v124
sw $t5,0($t0)
# Original instruction: lw v125,0(v124)
la $t5,label_313_v124
lw $t5,0($t5)
lw $t4,0($t5)
la $t0,label_315_v125
sw $t4,0($t0)
# Original instruction: slt v126,v125,v123
la $t5,label_315_v125
lw $t5,0($t5)
la $t4,label_316_v123
lw $t4,0($t4)
slt $t3,$t5,$t4
la $t0,label_320_v126
sw $t3,0($t0)
# Original instruction: xori v126,v126,1
la $t4,label_320_v126
lw $t4,0($t4)
xori $t4,$t4,1
la $t0,label_320_v126
sw $t4,0($t0)
# Original instruction: bnez v126,label_18_body
la $t5,label_320_v126
lw $t5,0($t5)
...
la $t5,label_323_v127
lw $t5,0($t5)
la $t4,label_324_v128
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: addiu $sp,$sp,-4
addiu $sp,$sp,-4
...
# Original instruction: addiu $sp,$sp,4
addiu $sp,$sp,4
# Original instruction: addiu v129,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_334_v129
sw $t5,0($t0)
# Original instruction: addiu v130,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_327_v130
sw $t5,0($t0)
# Original instruction: lw v131,0(v130)
la $t5,label_327_v130
lw $t5,0($t5)
lw $t4,0($t5)
la $t0,label_330_v131
sw $t4,0($t0)
...
la $t5,label_330_v131
lw $t5,0($t5)
la $t4,label_331_v132
lw $t4,0($t4)
add $t3,$t5,$t4
la $t0,label_333_v133
sw $t3,0($t0)
# Original instruction: sw v133,0(v129)
la $t5,label_333_v133
lw $t5,0($t5)
la $t4,label_334_v129
lw $t4,0($t4)
sw $t5,0($t4)
label_14_posttest:
# Original instruction: addiu v134,$fp,-40008
addiu $t5,$fp,-40008
la $t0,label_336_v134
sw $t5,0($t0)
# Original instruction: lw v135,0(v134)
la $t5,label_336_v134
lw $t5,0($t5)
lw $t4,0($t5)
la $t0,label_341_v135
sw $t4,0($t0)
...
la $t5,label_339_v136
lw $t5,0($t5)
lw $t4,0($t5)
la $t0,label_342_v137
sw $t4,0($t0)
# Original instruction: slt v138,v135,v137
la $t5,label_341_v135
lw $t5,0($t5)
la $t4,label_342_v137
lw $t4,0($t4)
slt $t3,$t5,$t4
la $t0,label_344_v138
sw $t3,0($t0)
# Original instruction: bnez v138,label_15_body
la $t5,label_344_v138
lw $t5,0($t5)
...
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_301_v118
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_305_v120
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_163_v43
...
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_344_v138
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_277_v106
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_175_v64
...
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_315_v125
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_334_v129
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_203_v73
...
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_290_v104
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_320_v126
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_263_v102
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_206_v70
...
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_285_v112
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_271_v107
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_264_v100
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_195_v69
...
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_313_v124
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_330_v131
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_36_v1
...
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_342_v137
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_261_v101
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_221_v81
...
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_333_v133
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_304_v119
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_327_v130
sw $t0,0($t1)
lw $t0,0($sp)
addi $sp,$sp,4
la $t1,label_170_v61
...
# Original instruction: addiu $sp,$sp,-4
addiu $sp,$sp,-4
# Original instruction: addiu v139,$fp,-4
addiu $t5,$fp,-4
la $t0,label_348_v139
sw $t5,0($t0)
# Original instruction: li v140,5
li $t5,5
la $t0,label_347_v140
sw $t5,0($t0)
# Original instruction: sw v140,0(v139)
la $t5,label_347_v140
lw $t5,0($t5)
la $t4,label_348_v139
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: addiu v141,$fp,-4
addiu $t5,$fp,-4
la $t0,label_350_v141
sw $t5,0($t0)
# Original instruction: lw v142,0(v141)
la $t5,label_350_v141
lw $t5,0($t5)
lw $t4,0($t5)
la $t0,label_353_v142
sw $t4,0($t0)
# Original instruction: addiu v143,$sp,-4
addiu $t5,$sp,-4
la $t0,label_354_v143
sw $t5,0($t0)
# Original instruction: sw v142,0(v143)
la $t5,label_353_v142
lw $t5,0($t5)
la $t4,label_354_v143
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: addiu $sp,$sp,-4
addiu $sp,$sp,-4
