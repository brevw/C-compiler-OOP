...
la $t5,label_278_v106
lw $t5,0($t5)
la $t4,label_279_v108
lw $t4,0($t4)
add $t3,$t5,$t4
la $t0,label_288_v105
sw $t3,0($t0)
...
la $t5,label_288_v105
lw $t5,0($t5)
la $t4,label_289_v111
lw $t4,0($t4)
add $t3,$t5,$t4
la $t0,label_291_v104
sw $t3,0($t0)
