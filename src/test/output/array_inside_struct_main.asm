...
la $t0,label_23_v4
sw $t5,0($t0)
# Original instruction: mul v0,v3,v4
la $t5,label_22_v3
lw $t5,0($t5)
la $t4,label_23_v4
lw $t4,0($t4)
...
la $t0,label_43_v13
sw $t5,0($t0)
# Original instruction: mul v9,v12,v13
la $t5,label_42_v12
lw $t5,0($t5)
la $t4,label_43_v13
lw $t4,0($t4)
...
la $t0,label_48_v9
sw $t3,0($t0)
# Original instruction: add v9,v9,v10
la $t3,label_48_v9
lw $t3,0($t3)
la $t4,label_46_v10
lw $t4,0($t4)
...
la $t0,label_63_v22
sw $t5,0($t0)
# Original instruction: mul v18,v21,v22
la $t5,label_62_v21
lw $t5,0($t5)
la $t4,label_63_v22
lw $t4,0($t4)
...
la $t0,label_91_v35
sw $t5,0($t0)
# Original instruction: mul v31,v34,v35
la $t5,label_90_v34
lw $t5,0($t5)
la $t4,label_91_v35
lw $t4,0($t4)
...
la $t0,label_98_v31
sw $t3,0($t0)
# Original instruction: add v31,v31,v32
la $t3,label_98_v31
lw $t3,0($t3)
la $t4,label_94_v32
lw $t4,0($t4)
...
la $t0,label_105_v41
sw $t5,0($t0)
# Original instruction: mul v37,v40,v41
la $t5,label_104_v40
lw $t5,0($t5)
la $t4,label_105_v41
lw $t4,0($t4)
...
la $t0,label_112_v37
sw $t3,0($t0)
# Original instruction: add v37,v37,v38
la $t3,label_112_v37
lw $t3,0($t3)
la $t4,label_108_v38
lw $t4,0($t4)
...
la $t0,label_119_v47
sw $t5,0($t0)
# Original instruction: mul v43,v46,v47
la $t5,label_118_v46
lw $t5,0($t5)
la $t4,label_119_v47
lw $t4,0($t4)
...
la $t0,label_139_v56
sw $t5,0($t0)
# Original instruction: mul v52,v55,v56
la $t5,label_138_v55
lw $t5,0($t5)
la $t4,label_139_v56
lw $t4,0($t4)
...
la $t0,label_144_v52
sw $t3,0($t0)
# Original instruction: add v52,v52,v53
la $t3,label_144_v52
lw $t3,0($t3)
la $t4,label_142_v53
lw $t4,0($t4)
...
la $t0,label_159_v65
sw $t5,0($t0)
# Original instruction: mul v61,v64,v65
la $t5,label_158_v64
lw $t5,0($t5)
la $t4,label_159_v65
lw $t4,0($t4)
...
la $t0,label_179_v74
sw $t5,0($t0)
# Original instruction: mul v70,v73,v74
la $t5,label_178_v73
lw $t5,0($t5)
la $t4,label_179_v74
lw $t4,0($t4)
...
la $t0,label_184_v70
sw $t3,0($t0)
# Original instruction: add v70,v70,v71
la $t3,label_184_v70
lw $t3,0($t3)
la $t4,label_182_v71
lw $t4,0($t4)
