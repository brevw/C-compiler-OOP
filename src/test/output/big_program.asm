...
la $t0,label_51_v14
sw $t5,0($t0)
# Original instruction: mul v9,v13,v14
la $t5,label_50_v13
lw $t5,0($t5)
la $t4,label_51_v14
lw $t4,0($t4)
...
la $t0,label_56_v9
sw $t3,0($t0)
# Original instruction: add v9,v9,v11
la $t3,label_56_v9
lw $t3,0($t3)
la $t4,label_54_v11
lw $t4,0($t4)
...
la $t0,label_73_v23
sw $t5,0($t0)
# Original instruction: mul v18,v22,v23
la $t5,label_72_v22
lw $t5,0($t5)
la $t4,label_73_v23
lw $t4,0($t4)
...
la $t0,label_94_v18
sw $t3,0($t0)
# Original instruction: add v18,v18,v20
la $t3,label_94_v18
lw $t3,0($t3)
la $t4,label_76_v20
lw $t4,0($t4)
...
la $t0,label_86_v29
sw $t5,0($t0)
# Original instruction: mul v24,v28,v29
la $t5,label_85_v28
lw $t5,0($t5)
la $t4,label_86_v29
lw $t4,0($t4)
...
la $t0,label_91_v24
sw $t3,0($t0)
# Original instruction: add v24,v24,v26
la $t3,label_91_v24
lw $t3,0($t3)
la $t4,label_89_v26
lw $t4,0($t4)
...
la $t0,label_123_v46
sw $t5,0($t0)
# Original instruction: mul v41,v45,v46
la $t5,label_122_v45
lw $t5,0($t5)
la $t4,label_123_v46
lw $t4,0($t4)
...
la $t0,label_128_v41
sw $t3,0($t0)
# Original instruction: add v41,v41,v43
la $t3,label_128_v41
lw $t3,0($t3)
la $t4,label_126_v43
lw $t4,0($t4)
...
la $t0,label_149_v57
sw $t5,0($t0)
# Original instruction: mul v52,v56,v57
la $t5,label_148_v56
lw $t5,0($t5)
la $t4,label_149_v57
lw $t4,0($t4)
...
la $t0,label_154_v52
sw $t3,0($t0)
# Original instruction: add v52,v52,v54
la $t3,label_154_v52
lw $t3,0($t3)
la $t4,label_152_v54
lw $t4,0($t4)
...
la $t0,label_171_v66
sw $t5,0($t0)
# Original instruction: mul v61,v65,v66
la $t5,label_170_v65
lw $t5,0($t5)
la $t4,label_171_v66
lw $t4,0($t4)
...
la $t0,label_192_v61
sw $t3,0($t0)
# Original instruction: add v61,v61,v63
la $t3,label_192_v61
lw $t3,0($t3)
la $t4,label_174_v63
lw $t4,0($t4)
...
la $t0,label_184_v72
sw $t5,0($t0)
# Original instruction: mul v67,v71,v72
la $t5,label_183_v71
lw $t5,0($t5)
la $t4,label_184_v72
lw $t4,0($t4)
...
la $t0,label_189_v67
sw $t3,0($t0)
# Original instruction: add v67,v67,v69
la $t3,label_189_v67
lw $t3,0($t3)
la $t4,label_187_v69
lw $t4,0($t4)
...
la $t0,label_221_v89
sw $t5,0($t0)
# Original instruction: mul v84,v88,v89
la $t5,label_220_v88
lw $t5,0($t5)
la $t4,label_221_v89
lw $t4,0($t4)
...
la $t0,label_226_v84
sw $t3,0($t0)
# Original instruction: add v84,v84,v86
la $t3,label_226_v84
lw $t3,0($t3)
la $t4,label_224_v86
lw $t4,0($t4)
...
la $t0,label_243_v98
sw $t5,0($t0)
# Original instruction: mul v93,v97,v98
la $t5,label_242_v97
lw $t5,0($t5)
la $t4,label_243_v98
lw $t4,0($t4)
...
la $t0,label_250_v93
sw $t3,0($t0)
# Original instruction: add v93,v93,v95
la $t3,label_250_v93
lw $t3,0($t3)
la $t4,label_246_v95
lw $t4,0($t4)
